...
void L298NX2::setPWMA(int pwmHz) {
  _motorA.setPWM(pwmHz);
}

unsigned long L298NX2::getPWMA() {
  return _motorA.getPWM();
}
...
void L298NX2::setPWMB(int pwmHz) {
  _motorB.setPWM(pwmHz);
}

unsigned long L298NX2::getPWMB() {
  return _motorB.getPWM();
}
